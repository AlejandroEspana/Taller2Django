...
class Solicitud(models.Model):
    ...
    tipo_solicitud = models.CharField(max_length=20, choices=TIPOS_SOLICITUD, verbose_name="Tipo de solicitud")
    ...
    archivo_adjunto = models.FileField(upload_to='adjuntos_solicitudes/', blank=True, null=True, verbose_name="Archivo adjunto")
